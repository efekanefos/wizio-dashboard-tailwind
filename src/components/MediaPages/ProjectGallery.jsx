  ...
  return (
    <div className="bg-[#E5E7EB] h-screen">
      <div className="h-full flex flex-col justify-between items-center w-full p-12 max-xl:px-5 max-md:px-4 max-sm:px-3">
        ...
        {/* Main Content */}
        <div className="flex flex-col justify-center items-center w-full max-w-[700px] mx-auto mt-3">
          {/* Title */}
          <h3 className="font-bold text-4xl text-center leading-10">Project Gallery</h3>

          {/* Property Types */}
          <div className="grid grid-cols-4 place-items-center justify-center items-center gap-5 w-full mt-5 max-md:flex max-md:flex-wrap">
