    ...
    <div className="p-12 max-md:p-6 max-sm:p-4">
      ...
      <div className="grid grid-cols-12 gap-4 p-5 rounded-[40px] bg-white bg-opacity-75 mt-20">
        ...
        <div className="col-span-9 max-sm:col-span-7">
          {/* Clients Container */}
          <div className="col-span-7 relative p-6 rounded-[40px] min-h-[568px] max-md:col-span-full">
            <div className="flex justify-start items-center gap-5">
              <h3 className="text-4xl leading-10 font-bold max-md:text-2xl max-sm:text-xl">Rules</h3>
