...
const TeamPage = () => {
  return (
    <div className="p-12 max-md:p-6 max-sm:p-4">
      ...
      {/* Client Data */}
      <div className="my-20 flex justify-start items-start max-md:mt-7 max-md:mb-11 max-sm:grid max-sm:grid-cols-2 max-sm:place-items-start max-sm:max-w-80">
        <div className="flex flex-col gap-3 pr-12 border-r-2 border-black max-md:pr-10 max-sm:pr-4 max-sm:w-full max-md:gap-1">
          <h1 className="text-8xl font-bold leading-[70px] max-md:text-4xl max-sm:text-2xl">54</h1>
          <p className="text-xl leading-4 max-md:text-xl max-sm:text-base">Team Members</p>
        </div>

        <div className="flex flex-col gap-3 px-12 border-r-2 border-black max-md:px-10 max-sm:pr-4 max-sm:pl-4 max-sm:w-full max-md:gap-1 max-sm:border-r-0">
          <h1 className="text-8xl font-bold leading-[70px] max-md:text-4xl max-sm:text-2xl">3</h1>
          <p className="text-xl leading-4 max-md:text-xl max-sm:text-base">Managers</p>
        </div>

        <div className="flex flex-col gap-3 px-12 border-r-2 border-black max-md:px-10 max-sm:pr-4 max-sm:w-full max-sm:pl-0 max-md:gap-1">
          <h1 className="text-8xl font-bold leading-[70px] max-md:text-4xl max-sm:text-2xl">15</h1>
          <p className="text-xl leading-4 max-md:text-xl max-sm:text-base">Sales Reps</p>
        </div>

        <div className="flex flex-col gap-3 pl-12 max-md:pl-10 max-sm:pl-4 max-sm:w-full max-md:gap-1">
          <h1 className="text-8xl font-bold leading-[70px] max-md:text-4xl max-sm:text-2xl">36</h1>
          <p className="text-xl leading-4 max-md:text-xl max-sm:text-base">Brokers</p>
        </div>
      </div>
