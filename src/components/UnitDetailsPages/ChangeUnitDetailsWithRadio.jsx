...
const ChangeUnitDetailsWithRadio = () => {
  return (
    <div className="bg-[#E5E7EB] h-screen">
      <div className="h-full flex flex-col justify-between items-center w-full p-12 max-xl:px-5 max-md:px-4 max-sm:px-3">
        ...
        <div className="flex flex-col justify-center items-center w-full max-w-[632px] mx-auto h-screen">
          {/* Title */}
          <h3 className="font-bold text-4xl text-center leading-10">Change Details</h3>
          {/* Rows */}
          ...
          <button className="text-white bg-black w-fit py-0.5 px-4 rounded-full my-5">Add features</button>

          <div className="w-full">
            <div className="flex justify-between items-center py-4">
              <p className="leading-6">Apply changes to this unit only</p>
              <input className="appearance-none bg-transparent w-4 h-4 border border-gray-600 rounded-full focus:border-[6px]" type="radio" />
            </div>
            <div className="flex justify-between items-center py-4">
              <p className="leading-6">Apply changes to multiple units</p>
              <input className="appearance-none bg-transparent w-4 h-4 border border-gray-600 rounded-full focus:border-[6px]" type="radio" />
            </div>
          </div>
          ...
          <div className="relative w-full">
            <select className="appearance-none text-gray-400 outline-none bg-transparent border border-gray-400 p-5 py-3 rounded-full w-full">
              <option value="ChooseUnits">Choose units</option>
              <option value="ChooseUnits">Choose units</option>
              <option value="ChooseUnits">Choose units</option>
            </select>
...
export default ChangeUnitDetailsWithRadio;
